...
inputCellLines <-
  "cell lines - MYC_PHB - mRNA expression (RNA-Seq RPKM).txt"
inputPatients <- c(
  "lymphoid_patients - MYC_PHB - mRNA expression (RNA-Seq RPKM).txt",
  "myeloid_patients - MYC_PHB - mRNA expression (RNA-Seq RPKM).txt",
  "bowel_patients - MYC_PHB - mRNA Expression, RSEM (Batch normalized from Illumina HiSeq_RNASeqV2).txt"
)
...
png("images/myc_phb_ratios_combined.png", width = 1800, height = 800)
